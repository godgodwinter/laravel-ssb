...
class admincetakcontroller extends Controller
{
    ...
    public function cetakhasilpenilaian(tahunpenilaian $tahunpenilaian,Request $request)
    {
        ...
        $pdf = PDF::loadview('pages.admin.tahunpenilaian.cetakhasilpenilaian',compact('datas','tahunpenilaian','hasil2'))->setPaper('a4', 'landscape');
        return $pdf->stream('prosespenilaian-'.$tahunpenilaian->id.'.pdf');
    }
