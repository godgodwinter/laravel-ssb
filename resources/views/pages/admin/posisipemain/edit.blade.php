...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('posisipemain')}}">@yield('title')</a></div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('posisipemain.update',$id->id)}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            <label for="nama">Nama Posisi <code>*)</code></label>
