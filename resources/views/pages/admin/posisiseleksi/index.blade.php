            ...
            <div class="card-body">
                ...
                <div class="d-flex bd-highlight mb-3 align-items-center">
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <form action="{{ route('posisiseleksi.cari',$tahunpenilaian->id) }}" method="GET">
                        ...
                        <div class="ml-auto p-2 bd-highlight">
                            <x-button-create link="{{route('posisiseleksi.create',$tahunpenilaian->id)}}"></x-button-create>
                        </form>
                ...
                <x-jsmultidel link="{{route('posisiseleksi.multidel',$tahunpenilaian->id)}}" />
