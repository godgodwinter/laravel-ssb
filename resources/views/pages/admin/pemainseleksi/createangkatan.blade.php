    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('pemainseleksi.storeangkatan',$tahunpenilaian->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        <select class="js-example-basic-single form-control-sm @error('angkatan')
                        is-invalid
                    @enderror" name="angkatan"  style="width: 75%" required>

                        @foreach ($pemain as $t)
                        @if($t->angkatan!='' && $t->angkatan!=null)
