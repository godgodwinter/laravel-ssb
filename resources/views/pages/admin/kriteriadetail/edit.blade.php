    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('kriteriadetail.update',[$kriteria->id,$id->id])}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            <label for="nama">Nama kriteriadetail <code>*)</code></label>
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            ...
                            <input type="number" name="bobot" id="bobot" class="form-control @error('bobot') is-invalid @enderror" value="{{old('bobot')!=null?old('bobot'):$id->bobot}}" required min="1" max="100">
