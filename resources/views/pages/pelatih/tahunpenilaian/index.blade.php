                    ...
                    @endphp
                        <tr id="sid{{ $data->id }}">
                                ...
                                <td class="text-center babeng-min-row">
                                    ...
                                    <a class="btn btn-dark btn-sm" href="#"  data-toggle="tooltip" data-placement="top" title="Proses Penilaian telah selesai!">
                                    ...
                                    <a href="{{route('pelatih.prosesperhitungan.grafikhasilpenilaian',$data->id)}}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Lihat Grafik!"><i class="fas fa-chart-bar"></i></a>

                                    {{-- <a href="{{route('pelatih.prosesperhitungan.cetakhasilpenilaian',$data->id)}}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Cetak PDF!"><i class="fas fa-file-pdf"></i></a> --}}
